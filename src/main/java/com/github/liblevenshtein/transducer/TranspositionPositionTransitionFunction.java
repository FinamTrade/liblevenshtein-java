...
public class TranspositionPositionTransitionFunction extends PositionTransitionFunction {
  ...
  public TranspositionPositionTransitionFunction stateFactory(StateFactory stateFactory) {
    this.stateFactory = stateFactory;
    return this;
  }

  public TranspositionPositionTransitionFunction positionFactory(PositionFactory positionFactory) {
